...
# Decrição: Customized keywords for WEB automation
##################################################################################################################################
...
Open Application Selecting Location
    [Documentation]    Open application in local environment

    Open Application	http://localhost:4723
    ...	                platformName=Android
    ...	                deviceName=Android Emulator
    ...	                automationName=UIAutomator2
    ...	                app=${EXECDIR}/app/app-android-calculator.apk
    ...	                udid=emulator-5554
    ...	                autoGrantPermissions=true

Wait Until Page Contains And Capture Screenshot
    [Documentation]    Checks if element is visible and returns status "True/False".
    ...                "timeout" assumes 5 seconds if not set
    ...                To capture image set the "screenshot" parameter to "True".
    [Arguments]    ${element}    ${timeout}=5

    ${visible}    Run Keyword And Return Status    Wait Until Page Contains    ${element}    ${timeout}
...
#         Set Screenshot Directory    ${project_path}/results/${TEST NAME}
#         Capture Page Screenshot
#     ELSE
#         Capture Page Screenshot
#     END